  ...
  var populationtable = document.getElementById("populationtable");
   ...
   document.getElementById("populationtable").style.display='none';
    ...
    function showpop(){
        ...
        document.getElementById('se').innerHTML = "Most populated countries in the world";
      
    }
    function showlang() {
      document.getElementById("populationtable").style.display = "none";
      document.getElementById("tableid").style.display = "block";
      document.getElementById('se').innerHTML = "Most populated speaking langauges in the world";
    }
